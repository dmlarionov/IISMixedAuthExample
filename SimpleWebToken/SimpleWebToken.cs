...
namespace Security.SimpleWebToken
{
    ...
    public class SimpleWebToken : SecurityToken
    {
        ...
        private string _serilaizedToken;
        private readonly List<SecurityKey> _keysList = new List<SecurityKey>();
        ...
        internal SimpleWebToken(NameValueCollection properties, string serializedToken, SecurityKey signingKey)
            : this(properties, signingKey)
        {
        ...
        /// </summary>
        /// <param name="properties">The collection represents all the key value pairs in the token.</param>
        public SimpleWebToken(NameValueCollection properties, SecurityKey signingKey)
        {
            if (properties == null)
            {
        ...
        public override ReadOnlyCollection<SecurityKey> SecurityKeys
        {
            get
            {
                return new ReadOnlyCollection<SecurityKey>(_keysList);
            }
        }
        ...
        public override DateTime ValidFrom
        {
            get
            {
                var validFrom = _properties[SimpleWebTokenConstants.ValidFrom];
        ...
        public override DateTime ValidTo
        {
            get
            {
                var expiryTime = _properties[SimpleWebTokenConstants.ExpiresOn];
        ...
        protected virtual DateTime GetTimeAsDateTime(string expiryTime)
        {
            ...
            var maxSeconds = (long)(DateTime.MaxValue - SwtBaseTime).TotalSeconds - 1;

...
Open http://localhost/test/WinAuth1 or http://localhost/test/WinAuth2 to pass windows authentication and see principal, then re-check http://localhost/test/Open.
Open http://localhost/test/FedAuth1 or http://localhost/test/FedAuth2 to pass federated authentication and see principal, then re-check http://localhost/test/Open.